...
const Int_t NumOfWireDC1[NumOfLayersDC1] = {48, 48, 48, 48, 48, 48};  // HYPS
const Int_t NumOfWireDC2[NumOfLayersDC2] = {79, 78, 78, 104, 104};  // HYPS
const Int_t NumOfWireDC3[NumOfLayersDC3] = {79, 78, 78, 104, 104};  // HYPS
