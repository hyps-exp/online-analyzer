...
// createRF
// -------------------------------------------------------------------------
TList* HistMaker::createRF( Bool_t flag_ps )
{
  // Determine the detector name
  TString strDet = CONV_STRING(kRF);
  ...
  // TDC ---------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kRF, 0, kTDC, 0);
  ...
  // Multiplicity -----------------------------------------------
  {
    const char* title = "RF_multiplicity";
...
// -------------------------------------------------------------------------
TList*
HistMaker::createTAG_SF(Bool_t flag_ps)
{
  TString strDet = CONV_STRING(kTAG_SF);
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    name_ps_files_.push_back(strDet);
  }
  ...
  { ///// ADC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kTAG_SF, 0, kADC, 0);
    for(Int_t i = 0; i<NumOfLayersTAG_SF; ++i){
      for(Int_t j = 0; j<NumOfSegTAG_SF; ++j){
	const char* title = NULL;
  ...
  { ///// ADC w/TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kTAG_SF, 0, kADCwTDC, 0);
    for(Int_t i = 0; i<NumOfLayersTAG_SF; ++i){
      for(Int_t j = 0; j<NumOfSegTAG_SF; ++j){
	const char* title = NULL;
	title = Form("%s_%s_%s_%d", nameDetector, nameSubDir, name_layer[i], j);
  ...
  { ///// TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kTAG_SF, 0, kTDC, 0);
    for(Int_t i = 0; i<NumOfLayersTAG_SF; ++i){
      for(Int_t j = 0; j<NumOfSegTAG_SF; ++j){
	const char* title = NULL;
	title = Form("%s_%s_%s_%d", nameDetector, nameSubDir, name_layer[i], j);
  ...
  }
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kTAG_SF, 0, kHitPat, 0);
    for(Int_t i = 0; i<NumOfLayersTAG_SF; ++i){
      const char* title = NULL;
  ...
  }
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kTAG_SF, 0, kMulti, 0);
    for(Int_t i = 0; i<NumOfLayersTAG_SF; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
...
// -------------------------------------------------------------------------
TList*
HistMaker::createTAG_PL(Bool_t flag_ps)
{
  TString strDet = CONV_STRING(kTAG_PL);
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    name_ps_files_.push_back(strDet);
  }
...
// -------------------------------------------------------------------------
TList*
HistMaker::createU_Veto(Bool_t flag_ps)
{
  TString strDet = CONV_STRING(kU_Veto);
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    name_ps_files_.push_back(strDet);
  }
  ...
  { ///// ADC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kU_Veto, 0, kADC, 0);
  ...
  { ///// ADC w/TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kU_Veto, 0, kADCwTDC, 0);
    for( Int_t seg=0; seg<NumOfSegU_Veto; ++seg ){
      const char* title = NULL;
      title = Form("%s_%s_%d", nameDetector, nameSubDir, seg);
      sub_dir->Add(createTH1(target_id + seg, title,
  ...
  { ///// TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kU_Veto, 0, kTDC, 0);
    for(Int_t seg = 0; seg<NumOfSegU_Veto; ++seg){
      const char* title = NULL;
      title = Form("%s_%s_%d", nameDetector, nameSubDir, seg);
      sub_dir->Add(createTH1(target_id + seg, title,
  ...
  { ///// Hit parttern
    Int_t target_id = getUniqueID(kU_Veto, 0, kHitPat, 0);
    top_dir->Add(createTH1(target_id, "U_Veto_hit_pattern",
			   NumOfSegU_Veto, 0, NumOfSegU_Veto,
			   "Segment", ""));
  }
  { ///// Multiplicity
    Int_t target_id = getUniqueID(kU_Veto, 0, kMulti, 0);
    top_dir->Add(createTH1(target_id, "U_Veto_multiplicity",
			   NumOfSegU_Veto, 0, NumOfSegU_Veto,
			   "Multiplicity", ""));
  }
  return top_dir;
...
// -------------------------------------------------------------------------
TList*
HistMaker::createT0(Bool_t flag_ps)
{
  TString strDet = CONV_STRING(kT0);
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    name_ps_files_.push_back(strDet);
  }
  ...
  { ///// ADC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kT0, 0, kADC, 0);
  ...
  { ///// ADC w/TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kT0, 0, kADCwTDC, 0);
    for( Int_t i=0; i<NumOfSegT0*2; ++i ){
      const char* title = NULL;
      if( i<NumOfSegT0 ){
	Int_t seg = i;
  ...
  { ///// TDC
    ...
    TList *sub_dir = new TList;
    sub_dir->SetName(nameSubDir);
    Int_t target_id = getUniqueID(kT0, 0, kTDC, 0);
    for(Int_t i = 0; i<NumOfSegT0*2; ++i){
      const char* title = NULL;
      if(i < NumOfSegT0){
	Int_t seg = i;
  ...
  { ///// Hit parttern
    ...
    top_dir->Add(createTH1(target_id, "T0_hit_pattern",
			   NumOfSegT0, 0, NumOfSegT0,
			   "Segment", ""));
  }
  { ///// Multiplicity
    Int_t target_id = getUniqueID(kT0, 0, kMulti, 0);
    top_dir->Add(createTH1(target_id, "T0_multiplicity",
			   NumOfSegT0, 0, NumOfSegT0,
			   "Multiplicity", ""));
  }
  return top_dir;
...
{
  // Determine the detector name
  TString strDet = CONV_STRING(kSDC0);
  // name list of crearted detector
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    // name list which are displayed in Ps tab
  ...
  // layer configuration
  const char* name_layer[NumOfLayersSDC0] = {"X", "XP", "U", "UP"};
  ...
  // TDC---------------------------------------------------------
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kSDC0, 0, kTDC, 0);
    ...
    //TDCwide
    target_id = getUniqueID(kSDC0, 0, kTDC, 10);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
    ...
    // TDCwTOTCUT -------------------------------------------------
    // Make histogram and add it
    target_id = getUniqueID(kSDC0, 0, kTDC, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
    ...
    target_id = getUniqueID(kSDC0, 0, kTDC2D, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
    ...
    // TDC 2D ---------------------------------------------------
    target_id = getUniqueID(kSDC0, 0, kTDC2D, kTOTcutOffset+20);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
    ...
    // TDC 2D wTOTCUT ---------------------------------------------------
    target_id = getUniqueID(kSDC0, 0, kTDC2D, kTOTcutOffset+30);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
  ...
  // TOT---------------------------------------------------------
  {
    ...
    Int_t target_id = getUniqueID(kSDC0, 0, kADC, 0);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // CTOT---------------------------------------------------------
    target_id = getUniqueID(kSDC0, 0, kADC, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
  ...
  // HitPat------------------------------------------------------
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kSDC0, 0, kHitPat, 0);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
			     NumOfWireSDC0, 0, NumOfWireSDC0,
			     "wire", ""));
    }

    // HitPatwTOTCUT -----------------------------------------------
    // Make histogram and add it
    target_id = getUniqueID(kSDC0, 0, kHitPat, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
  ...
  // Multiplicity -----------------------------------------------
  {
    ...
    // Make histogram and add it
    // without TDC gate
    Int_t target_id = getUniqueID(kSDC0, 0, kMulti, 0);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // with TDC gate
    target_id = getUniqueID(kSDC0, 0, kMulti, NumOfLayersSDC0);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
    ...
    // Make histogram and add it
    // without TDC gate
    target_id = getUniqueID(kSDC0, 0, kMulti, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // with TDC gate
    target_id = getUniqueID(kSDC0, 0, kMulti, NumOfLayersSDC0+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC0; ++i){
      const char* title = NULL;
...
TList* HistMaker::createSDC1( Bool_t flag_ps )
{
  ...
  // layer configuration
  const char* name_layer[NumOfLayersSDC1] = {"XPP", "V", "UP", "U", "XP", "X"};
  ...
  // TOT---------------------------------------------------------
  {
    ...
    // TOT1st----------------------------------------------------
    target_id = getUniqueID(kSDC1, 0, kTDC2D,  10+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC1; ++i){
      const char* title = NULL;
      title = Form("%s_%s1st_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // TOT2D---------------------------------------------------
    target_id = getUniqueID(kSDC1, 0, kTDC2D,  40+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC1; ++i){
      const char* title = NULL;
      title = Form("%s_%s2D_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
  ...
  // TOT_TDC2D
  {
    ...
    Int_t target_id = getUniqueID(kSDC1, 0, kTOTTDC2D,  kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC1; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
...
TList* HistMaker::createSDC2( Bool_t flag_ps )
{
  ...
  // layer configuration
  const char* name_layer[NumOfLayersSDC2] = {"V", "UP", "U", "XP", "X"};
  ...
  // TOT---------------------------------------------------------
  {
    ...
    // TOT1st----------------------------------------------------
    target_id = getUniqueID(kSDC2, 0, kTDC2D,  10+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC2; ++i){
      const char* title = NULL;
      title = Form("%s_%s1st_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // TOT2D---------------------------------------------------
    target_id = getUniqueID(kSDC2, 0, kTDC2D,  40+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC2; ++i){
      const char* title = NULL;
      title = Form("%s_%s2D_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
  ...
  // TOT_TDC2D
  {
    ...
    Int_t target_id = getUniqueID(kSDC2, 0, kTOTTDC2D,  kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC2; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
...
TList* HistMaker::createSDC3( Bool_t flag_ps )
{
  ...
  // layer configuration
  const char* name_layer[NumOfLayersSDC3] = {"V", "UP", "U", "XP", "X"};
  ...
  // TDC---------------------------------------------------------
  {
    ...
    // TDCwTOTCUT -------------------------------------------------
    // Make histogram and add it
    target_id = getUniqueID(kSDC3, 0, kTDC, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    target_id = getUniqueID(kSDC3, 0, kTDC2D, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s1st_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // TDC 2D ---------------------------------------------------
    target_id = getUniqueID(kSDC3, 0, kTDC2D, kTOTcutOffset+20);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_%s2D_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
    ...
    // TDC 2D wTOTCUT ---------------------------------------------------
    target_id = getUniqueID(kSDC3, 0, kTDC2D, kTOTcutOffset+30);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s2D_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
  ...
  // TOT---------------------------------------------------------
  {
    ...
    // CTOT---------------------------------------------------------
    target_id = getUniqueID(kSDC3, 0, kADC, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // TOT1st----------------------------------------------------
    target_id = getUniqueID(kSDC3, 0, kTDC2D,  10+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_%s1st_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // TOT2D---------------------------------------------------
    target_id = getUniqueID(kSDC3, 0, kTDC2D,  40+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_%s2D_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
  ...
  // TOT_TDC2D
  {
    ...
    Int_t target_id = getUniqueID(kSDC3, 0, kTOTTDC2D,  kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH2(target_id + i, title,
  ...
  // HitPat------------------------------------------------------
  {
    ...
    // HitPatwTOTCUT -----------------------------------------------
    // Make histogram and add it
    target_id = getUniqueID(kSDC3, 0, kHitPat, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
  ...
  // Multiplicity -----------------------------------------------
  {
    ...
    // Make histogram and add it
    // without TDC gate
    target_id = getUniqueID(kSDC3, 0, kMulti, kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
    ...
    // with TDC gate
    target_id = getUniqueID(kSDC3, 0, kMulti, NumOfLayersSDC3+kTOTcutOffset);
    for(Int_t i = 0; i<NumOfLayersSDC3; ++i){
      const char* title = NULL;
      title = Form("%s_C%s_%s_wTDC", nameDetector, nameSubDir, name_layer[i]);
      sub_dir->Add(createTH1(target_id + i, title,
...
// createE_Veto
// -------------------------------------------------------------------------
TList* HistMaker::createE_Veto( Bool_t flag_ps )
{
  // Determine the detector name
  TString strDet = CONV_STRING(kE_Veto);
  // name list of crearted detector
  name_created_detectors_.push_back(strDet);
  if(flag_ps){
    // name list which are displayed in Ps tab
  ...
  // ADC---------------------------------------------------------
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kE_Veto, 0, kADC, 0);
    for(Int_t i = 0; i<NumOfSegE_Veto*2; ++i){
      const char* title = NULL;
      if(i < NumOfSegE_Veto){
	Int_t seg = i;
	title = Form("%s_%s_%dL", nameDetector, nameSubDir, seg);
  ...
  // ADCwTDC ---------------------------------------------------------
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kE_Veto, 0, kADCwTDC, 0);
    for( Int_t i=0; i<NumOfSegE_Veto*2; ++i ){
      const char* title = NULL;
      if( i<NumOfSegE_Veto ){
	Int_t seg = i;
  ...
  // TDC ---------------------------------------------------------
  {
    ...
    // Make histogram and add it
    Int_t target_id = getUniqueID(kE_Veto, 0, kTDC, 0);
    for(Int_t i = 0; i<NumOfSegE_Veto*2; ++i){
      const char* title = NULL;
      if(i < NumOfSegE_Veto){
	Int_t seg = i;
  ...
  // Hit parttern -----------------------------------------------
  {
    const char* title = "E_Veto_hit_pattern";
    Int_t target_id = getUniqueID(kE_Veto, 0, kHitPat, 0);
    // Add to the top directory
    top_dir->Add(createTH1(target_id, title,
			   NumOfSegE_Veto, 0, NumOfSegE_Veto,
			   "Segment", ""));
  }

  // Multiplicity -----------------------------------------------
  {
    const char* title = "E_Veto_multiplicity";
    Int_t target_id = getUniqueID(kE_Veto, 0, kMulti, 0);
    // Add to the top directory
    top_dir->Add(createTH1(target_id, title,
			   NumOfSegE_Veto, 0, NumOfSegE_Veto,
			   "Multiplicity", ""));
...
TList* HistMaker::createBGO( Bool_t flag_ps )
{
  ...
  // FADC---------------------------------------------------------
  {
    ...
    TString strSubDir_wt  = CONV_STRING(kFADCwTDC);
    const char* nameSubDir_wt = strSubDir_wt.Data();

    Int_t target_id_wt = getUniqueID(kBGO, 0, kFADCwTDC, 0);
    for(Int_t i = 0; i<NumOfSegBGO; ++i){
      const char* title = NULL;
      Int_t seg = i+1; // 1 origin
      title = Form("%s_%s%d", nameDetector, nameSubDir_wt, seg);
      sub_dir->Add(createTH2(target_id_wt + i+1, title, // 1 origin
  			     1024, 0, 1024,
  			     4096, 0, 24576,
  			     "Sample", "FADC [ch]"));
    }
  ...
  // Integrated ADC -------------------------------------------------
  {
    ...
    TString strSubDir_wt  = CONV_STRING(kADCwTDC);
    const char* nameSubDir_wt = strSubDir_wt.Data();

    Int_t target_id_wt = getUniqueID(kBGO, 0, kADCwTDC, 0);
    for(Int_t i = 0; i<NumOfSegBGO; ++i){
      const char* title = NULL;
      Int_t seg = i+1; // 1 origin
      title = Form("%s_%s%d", nameDetector, nameSubDir_wt, seg);
      sub_dir->Add(createTH1(target_id_wt + i+1, title, // 1 origin
  			     1000, 0, 200000,
  			     "ADC [ch]", ""));
    }

    target_id = getUniqueID(kBGO, 0, kADC2D, 0);
    sub_dir->Add(createTH2(++target_id, "BGO_ADC_2D", // 1 origin
			   NumOfSegBGO, 0, NumOfSegBGO,
			   200, 0, 200000,
			   "BGO segment", "ADC [ch]"));

    sub_dir->Add(createTH2(++target_id, "BGO_ADC_2D_wTDC", // 1 origin
			   NumOfSegBGO, 0, NumOfSegBGO,
			   200, 0, 200000,
			   "BGO segment", "ADC [ch]"));
  ...
  // HitPat---------------------------------------------------------
  {
    ...
    sub_dir->Add(createTH1(++target_id, "BGO_HitPat (w good TDC)", // 1 origin
			   NumOfSegBGO, 0, NumOfSegBGO,
			   "BGO segment", ""));
    // insert sub directory
    top_dir->Add(sub_dir);
  ...
  // HitPat---------------------------------------------------------
  {
    ...
    sub_dir->Add(createTH1(++target_id, "BGO_Multiplicity", // 1 origin
			   NumOfSegBGO, 0, NumOfSegBGO,
			   "Multiplicity", ""));

    sub_dir->Add(createTH1(++target_id, "BGO_Multiplicity (w good TDC)", // 1 origin
			   NumOfSegBGO, 0, NumOfSegBGO,
			   "Multiplicity", ""));
    // insert sub directory
    top_dir->Add(sub_dir);
...
TList* HistMaker::createVMEEASIROC( Bool_t flag_ps )
{
  ...
  // ADC-2D LowGain -----------------------------------------------
  {
    ...
    for(Int_t i=0; i<NumOfPlaneVMEEASIROC; ++i){
      const char* title = NULL;
      title = Form("%s_%s_%d", nameDetector, sub_name, PlaneIdOfVMEEASIROC[i]);
      sub_dir->Add(createTH2(target_id + i, title, // 1 origin
			     NumOfSegVMEEASIROC, 0, NumOfSegVMEEASIROC,
			     4096, 0, 4096,
			     "ch", "ADC [ch]"));
    }
  ...
  // 	sub_sub_dir->Add(createTH2(target_id + i, title,
  // 				   4096, 0, 4096,
  // 				   150, 0, 150,
  // 				   "ADC [ch]", "TOT [ch]"));
  //     }
